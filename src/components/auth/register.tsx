...
import MessageComponent from "./message-info";
...
const Register = () => {
  ...
  const googleAuth = () => {
    window.open(`https://scribly-note-server-production.up.railway.app/v1/auth/google/callback`, "_self");
  };
    ...
    <div>
      <section className="h-full w-full">
        <div className="text center flex flex-col justify-center items-center  font-inter ">
          ...
          <h2 className="self-start ml-[4rem]  mt-9 text-xl font-medium  tracking-wide font-inter md:self-auto md:mr-[12rem]">Create your account</h2>
        ...
        <form className="form" onSubmit={submitForm}>
          <div className="flex flex-col justify-center items-center ">
            ...
            <input onChange={(e) => setName(e.target.value)} className="px-4 py-2 placeholder:text-slate-800 border border-slate-400 rounded-md p-2  mb-3 input_width md:px-4 md:py-2 " placeholder="Name" name="name" />

            <input type="email" onChange={(e) => setEmail(e.target.value)} className="px-4 py-2 placeholder:text-slate-800 border border-slate-400 rounded-md p-2  mb-3 input_width md:px-4 md:py-2" placeholder="Email" name="email" />

            <input type="password" onChange={(e) => setPassword(e.target.value)} className="px-4 py-2 placeholder:text-slate-800 border border-slate-400 rounded-md p-2  mb-3 input_width md:px-4 md:py-2" placeholder="Password" name="password" />
