...
export const CrossArrow: React.FC = () => {
  return (
    <svg
...
export const SerchIcon: React.FC = () => {
  return (
    <svg
      className="w-5"
      xmlns="http://www.w3.org/2000/svg"
