      ...
      <div className={"hidden md:grid md:grid-cols-4"}>
        {sidebar && (
          <div className="md:col-span-1">
            <MainHeader AddNote={onAddNote} notes={note} activeNote={activeNote} user={user} addActiveNote={setActiveNote} />
          </div>
        )}
        <div className={`hidden md:block md:h-screen ${sidebar ? "md:col-span-3" : "md:col-span-4"}`}>
          <EditorComponent setSidebar={setSideBar} setCounter={setCounter} activeNote={getActiveNote()} notes={note} setActiveNote={setActiveNote} />
        </div>
      </div>
